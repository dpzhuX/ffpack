...
# Test mvalFOSM
###############################################################################
def test_mvalFOSM_dimLessThanOneCase_valueError():
    dim = 0
    ...
    with pytest.raises( ValueError ):
        _, _ = rrm.mvalFOSM( dim, g, dg, mus, sigmas )


def test_mvalFOSM_musDimIncorrectCase_valueError():
    dim = 2
...
def test_mvalFOSM_sigmasDimIncorrectCase_valueError():
    dim = 2
...
def test_mvalFOSM_twoVariablesCase_scalar( dgExists ):
    dim = 2
...
@pytest.mark.parametrize( "dgExists", [ 0, 1 ] )
def test_mvalFOSM_fourVariablesCase_scalar( dgExists ):
    dim = 4
